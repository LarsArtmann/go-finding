...
| Fix `safePath, _ =` error discard in `pipeline/fix_applier.go:305`          | ⬜ `TODO` | Low    | Low    | Self-debt from 2026-08-03 caching session (report §f.2); AGENTS.md duplication half fixed 2026-09-08. |
