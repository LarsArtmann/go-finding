...
// The Summary coverage contract (2026-09-22, erraudit TODO f2/f3):
// FilesScanned is ALWAYS serialized — "scanned 0" is load-bearing coverage
// evidence and must stay distinguishable from an omitted field — and
// SkippedModules serializes only when set, so module-agnostic tools produce
// unchanged JSON.
