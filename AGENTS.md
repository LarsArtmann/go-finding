...
- **Consumer counts are unverified since v1.0.0** — The v1.0.0 consumer audit (`docs/reviews/2026-07-05_20-55_consumer-audit.html`) counted consumers at that point in time. Any hardcoded count in docs/ROADMAP may be stale. Do not assert specific consumer numbers without re-running the audit.
