...
> **Disposition (docs-health pass 2026-09-08):** EXECUTED same day — outcome in
> `docs/status/2026-08-08_11-24_consumer-api-refactor-completion.md`. Phase 1
> shipped as v1.6.0 (ParseConfidence, Template.Builder); Phases 2–3 done in the
> sibling repos (SDK +560 LOC, humanize-linter −97 LOC); Phase 4 verified except
> publishing, which is tracked in TODO_LIST.md ("Bump consumers to v1.7.0").
> The "12-Minute Task Breakdown" section duplicates the phase tables above.
