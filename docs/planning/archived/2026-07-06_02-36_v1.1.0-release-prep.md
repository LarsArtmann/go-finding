...
> **📦 RESOLUTION STATUS (updated 2026-07-16):** ALL 15 tasks completed. v1.1.0 released (2026-07-06).
> Subsequently superseded by v1.2.0 same day (which fixed the stale version.go). See
> `docs/status/2026-07-06_03-09_v1.1.0-released.md` for the release report.
