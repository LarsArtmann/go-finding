...
| 2  | __Complete 2026-0_ inventory_* — ~95 files (44 active md, 6 HTML, diagrams, ~45 already archived); formats classified (prose vs table per §f section)                                                                                                                                                         | glob + per-file classifier                                         |
